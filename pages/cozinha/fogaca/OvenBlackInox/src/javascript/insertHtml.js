...
<html lang="en">
  ...
  <body class="m-auto max-w-vtex">
    <div class="overflow-x-hidden">
      ...
      <section
        class="flex flex-col gap-2 mt-20 text-white md:mt-40 bg-black-default md:rounded-3xl">
        <div class="grid grid-cols-2 gap-8">
          <div class="relative z-10 mt-8 ml-8 space-y-6 md:mt-16 md:ml-20">
            <h1 class="text-base font-bold uppercase  md:text-3xl font-poppins">
              DESCUBRA UMA NOVA ERA DE SABORES COM A FRITADEIRA AIRFRY OVEN DIGITAL BLACK INOX
            </h1>
            <p class="font-inter font-light tracking-tighter text-sm sm:text-base pt-5 sm:pt-10 md:pt-20 lg:pt-0 w-[200%] lg:w-[90%]">
          ...
          <div class="relative flex items-start justify-start w-[120%]">
            <img
              ...
              class="mr-0 -translate-y-[2rem] w-[14rem] -translate-x-[2rem] sm:-translate-y-[2rem] md:-translate-y-[5rem] md:-translate-x-[4rem] md:mr-5 md:w-full"
              alt="" />
          </div>
        </div>

        <div class="flex flex-col-reverse gap-4 px-8 pb-20 mt-10 md:-mt-5 md:px-20 lg:grid lg:grid-cols-2">
          ...
          <div class="flex flex-col items-center  justify-center gap-4 mt-12 md:-mt-0 font-poppins">
            ...
            <p
              class="md:text-center font-inter font-light tracking-tighter text-sm sm:text-base lg:w-[100%] w-full">
      ...
      <section class="grid lg:grid-cols-2 m-auto md:ml-10  mt-10 md:mt-0">
        ...
        <div class="flex-col hidden md:flex items-end pb-[3rem] rounded-b-full lg:bg-red-default ">
          <img
      ...
      <section class="grid m-auto -mt-5 lg:grid-cols-2">
        <div class="flex flex-col pb-20 rounded-b-full lg:bg-red-default">
          <div class="flex flex-col gap-8 mx-5 lg:m-auto md:justify-center">
            ...
            <p class="lg:text-white mb-4 text-black font-inter md:pr-5 md:pl-5 font-light tracking-tighter w-[80%] md:w-[26rem]">
